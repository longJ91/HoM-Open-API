        ...
        protected void onPostExecute(final String result) {
            ...
            if(!result.equals("")) {
                if (Result.equals("connection error")) {
                    ...
                    Toast.makeText(getApplicationContext(), result, Toast.LENGTH_SHORT).show();
                } else if (Result.equals("failure")) {      //parser.resForLogin(result)) {
           ...
           /*     mPasswordView.setError(getString(R.string.error_incorrect_password));
                mPasswordView.requestFocus();*/
                    ...
                    editor.putString(PreferencePutter.PREF_ID, result);
                    editor.putBoolean(PreferencePutter.REGISTER, true);
                    editor.commit();
                ...
                Intent myAct1 = new Intent(LoginActivity.this, Web.class);
